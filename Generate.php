...
class Generate
{
    ...
    {
        return $this->deleteFile($pathView . 'add_bottle.html');
    }
    ...
    private function buildIndex($path, $pathTemplate, $fileName, $tableName, $code, $data)
    {
        ...
        if (in_array('recyclebin', $menuArr)) {
            $form = '{include file="'.$tableName.'/form" /}';
            $th = '{include file="'.$tableName.'/th" /}';
            $td = '{include file="'.$tableName.'/td" /}';
